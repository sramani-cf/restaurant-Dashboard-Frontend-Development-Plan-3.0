...
const Textarea = React.forwardRef(({ className, error, label, placeholder, ...props }, ref) => {
        ...
        <motion.label
          className={cn(
            ...
            showFloatingLabel
              ...
              : "top-6 left-4 -translate-y-1/2 text-slate-400 bg-transparent opacity-0"
          )}
          animate={{
